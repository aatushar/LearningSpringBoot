...
public class DistrictController {
	...
	@PostMapping("/add")
	public ResponseEntity<ApiResponse> addDistrict(@RequestBody DistrictRequestDto dto) {
    ...
    public ResponseEntity<ApiResponse> updaiteDistrict(@PathVariable("id") Long id, @RequestBody DistrictRequestDto dto) {
