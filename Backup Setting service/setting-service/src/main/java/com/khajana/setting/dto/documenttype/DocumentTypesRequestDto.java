...
@AllArgsConstructor
@NoArgsConstructor
public class DocumentTypesRequestDto {
    @NotNull(message = "docType can not be empty")
    @Size(max = 100, message = "docType bn should not be greater than 100 characters")
    private String docType;
    @NotNull(message = "docTypeBn can not be empty")
    @Size(max = 100, message = "docTypeBn should not be greater than 100 characters")
