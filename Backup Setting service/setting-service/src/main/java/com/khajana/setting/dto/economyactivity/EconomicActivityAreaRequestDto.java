...
@AllArgsConstructor
@NoArgsConstructor
public class EconomicActivityAreaRequestDto {
    @NotNull(message = "economic_activity_id can not be empty")
    @JsonDeserialize(using = LongDeserializer.class)
    private Long economicActivityId;

    @NotNull(message = "economicActivityAreaName can not be empty")
    @Size(max = 100, message = "economicActivityName  should not be greater than 100 characters")
    private String economicActivityAreaName;

    @NotNull(message = "economicActivityAreaNameBn can not be empty")
    @Size(max = 100, message = "economicActivityNameBn should not be greater than 100 characters")
