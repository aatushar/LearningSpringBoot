...
public class DivisionController {
    ...
    @PostMapping("/add")
    public ResponseEntity<ApiResponse> addDivision(@Valid @RequestBody DivisionRequestDto dto) {
...
//    public ResponseEntity<ApiResponse> updaiteDivision(@PathVariable("id") Long id,
