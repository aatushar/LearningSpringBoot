package com.khajana.setting.controller.language;

import com.khajana.setting.dto.ApiResponse;
import com.khajana.setting.dto.SortField;
import com.khajana.setting.dto.language.LanguageRequestDto;
import com.khajana.setting.service.language.LanguageService;
...
@RestController
@RequestMapping("/setting/api/v1/language")
public class LanguageController {
    ...
    public ResponseEntity<ApiResponse> getCiommsionerateInfos(@RequestParam(defaultValue = "0") int pageNo,
        ...
        try {
            var results = languageService.findAllLanguages(pageable);
    ...
    public ResponseEntity<ApiResponse> getCiommsionerateInfoById(@PathVariable("id") Long id) {
        ...
        ApiResponse apiResponse;
        try {
            var result = languageService.findLanguageById(id);
    ...
    public ResponseEntity<ApiResponse> getDroupDown() {
        ...
        ApiResponse apiResponse;
        try {
            var result = languageService.getDropDown();
    ...
    @PostMapping("/add")
    public ResponseEntity<ApiResponse> addLanguage(@Valid @RequestBody LanguageRequestDto dto) {
    ...
    public ResponseEntity<ApiResponse> updateFiscalYear(@Valid @PathVariable("id") Long id,
        ...
        var result = languageService.updateLanguage(id, dto);
    ...
    public ResponseEntity<ApiResponse> deleiteLanguage(@PathVariable("id") Long id) {
