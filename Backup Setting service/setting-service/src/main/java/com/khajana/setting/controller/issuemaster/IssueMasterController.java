...
import com.khajana.setting.service.issuemaster.IssueMasterService;
...
@RestController
@RequestMapping("/setting/api/v1/issue")
public class IssueMasterController {
    ...
    public ResponseEntity<ApiResponse> getAllFinancialYearInfo(@RequestParam(defaultValue = "0") int pageNo,
        ...
        try {
            ...
            var result = issueMasterService.findAllIssues(pageable);
