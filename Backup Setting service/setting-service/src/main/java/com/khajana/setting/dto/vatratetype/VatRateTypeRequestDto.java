...
@AllArgsConstructor
@NoArgsConstructor
public class VatRateTypeRequestDto {
    @NotNull(message = "vatRateTypeName can not be empty")
    @Size(max = 100, message = "vatRateTypeName should not be greater than 100 characters")
    private String vatRateTypeName;
    @NotNull(message = "vatRateTypeNameBn can not be empty")
    @Size(max = 100, message = "vatRateTypeNameBn should not be greater than 100 characters")
